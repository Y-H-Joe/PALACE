...
model_dp=PALACE_models/PALACE_v1_piece_928.pt
data_dp=data/PALACE_test.nonenzyme.tsv_batch2
smi_vocab_dp=vocab/smi_vocab_v2.pkl
prot_vocab_dp=vocab/prot_vocab.pkl
output_dp=PALACE_predict_v1.nonenzyme.batch2.txt



~/anaconda3/envs/PALACE/bin/python PALACE_predict_large.py $model_dp $data_dp $smi_vocab_dp $prot_vocab_dp $output_dp
