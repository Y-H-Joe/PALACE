...
from PALACE import (printer,PALACE_v7,logging,save_on_master,train_PALACE,model_diagnose,
                    set_random_seed,load_data,PALACE_Encoder_v2,MaskedSoftmaxCELoss,
                    assign_gpu,init_weights_v2,setup_gpu,PALACE_Decoder_v4,predict_PALACE,
                    test_PALACE)
...
#%% Training
    ...
    net = PALACE_v7(smi_encoder, prot_encoder, decoder,args.feat_space_dim,
