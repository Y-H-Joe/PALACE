...
from PALACE import (printer,PALACE_v4,logging,save_on_master,train_PALACE,model_diagnose,
...
#%% Settings
    class Args:
        def __init__(self):
            ...
            self.prot_blks =  1 #8 #9 # 5
            self.smi_blks =  1 #8 #9 # 5
            self.cross_blks = 1 #8 #9 # 9
            self.dec_blks = 1 #14 #14 # 14
