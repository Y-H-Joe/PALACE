...
for piece in {0..14}
do
     if test ! -f PALACE_models/PALACE_USPTO_MIT_inittrick_piece_${piece}.pt;then
        ~/anaconda3/envs/PALACE/bin/python PALACE_USPTO_MIT_inittrick_train.py $piece $world_size
      fi
done
