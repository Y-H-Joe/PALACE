...
from modules import (printer,PALACE,logging,save_on_master,train_PALACE,
                    ...
                    assign_gpu,xavier_init_weights,setup_gpu )


def main(rank, world_size,piece):
# ===============================Settings======================================
#%% Settings
    class Args:
        def __init__(self):
...
#%% Training
    ...
    tp1 = time.time()
    vocab_dir = ['./vocab/merge_vocab.pkl','./vocab/merge_vocab.pkl']
    data_iter, src_vocab, tgt_vocab = load_data(rank, world_size,
    ...
    if first_train:
        ...
        checkpoint_path = './PALACE_models/checkpoint.pt'
    ...
    save_on_master(checkpoint, './PALACE_models/PALACE_piece_{}.pt'.format(piece))
    save_on_master(checkpoint, './PALACE_models/checkpoint.pt')
