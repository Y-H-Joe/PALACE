...
for piece in {1..14}
do
     if test ! -f PALACE_models/PALACE_USPTO_MIT_notransfer_piece_${piece}.pt;then
        ~/anaconda3/envs/PALACE/bin/python PALACE_USPTO_MIT_notransfer_train.py $piece $world_size
      fi
done
