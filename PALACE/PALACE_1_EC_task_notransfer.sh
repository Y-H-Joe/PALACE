...
for piece in {0..14}
do
     if test ! -f PALACE_models/PALACE_EC_task1_notransfer_piece_${piece}.pt;then
        ~/anaconda3/envs/PALACE/bin/python PALACE_EC_task1_notransfer_train.py $piece $world_size
      fi
done
