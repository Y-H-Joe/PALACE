...
from PALACE import (printer,PALACE_v8,logging,save_on_master,train_PALACE,model_diagnose,
...
#%% Training
    ...
    net = PALACE_v8(smi_encoder, prot_encoder, decoder,args.feat_space_dim,
