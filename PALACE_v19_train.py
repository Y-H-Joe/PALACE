...
"""
from PALACE import (printer,PALACE_v11,PALACE_v4,PALACE_v6,logging,save_on_master,train_PALACE,model_diagnose,
...
#%% Settings
    class Args:
        def __init__(self):
            ...
            self.lr = 0.05
            # number of epochs
            self.num_epochs = 150 # 30 for 4 gpus
...
#%% Training
    ...
    smi_encoder = PALACE_Encoder_v2(
        ...
        args.smi_blks, args.dropout,args.prot_blks , args.dec_blks, device = device)

    prot_encoder = PALACE_Encoder_v2(
        len(prot_vocab), args.feat_space_dim, args.ffn_num_hiddens, args.num_heads,
        args.prot_blks, args.dropout, args.prot_blks, args.dec_blks,
        is_prot = True, num_steps = args.num_steps,device = device)

    cross_encoder = PALACE_Encoder_v2(
        len(src_vocab), args.feat_space_dim, args.ffn_num_hiddens, args.num_heads,
        args.cross_blks, args.dropout, args.smi_blks + args.prot_blks + args.cross_blks, args.dec_blks,
    ...
    decoder = PALACE_Decoder_v2(
        ...
        args.dec_blks, args.dropout, args.prot_blks + args.dec_blks, args.dec_blks + args.prot_blks)


    net = PALACE_v12(smi_encoder, prot_encoder,cross_encoder, decoder,args.num_steps,
                     args.num_heads ,args.feat_space_dim,
                    args.ffn_num_hiddens,args.dropout, args.prot_blks, args.dec_blks)

    """
    net = PALACE_v11(smi_encoder, prot_encoder,cross_encoder, decoder, args.num_heads,
                     args.batch_size,args.num_steps, args.feat_space_dim,
                     args.ffn_num_hiddens,args.dropout, args.prot_blks, args.dec_blks)
    """
    """
    net = PALACE_v4(smi_encoder, prot_encoder, cross_encoder, decoder,args.feat_space_dim,
