...
#%% Predicting
    ...
    with torch.no_grad():
        with open(output_dp,'w') as o:
            for src in samples:
                prediction = predict_PALACE(net, src, prot_vocab, smi_vocab, smi_vocab, args.num_steps,device,beam,save_attention_weights=False)
...
if __name__ == '__main__':
    ...
    output_dp = 'PALACE_v11_model_161_piece_500.txt'
