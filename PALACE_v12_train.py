...
from PALACE import (printer,PALACE_v3,logging,save_on_master,train_PALACE,model_diagnose,
...
def main(rank, world_size,piece,model_id,vocab_dir,loss_log,data_dir,test_dir):
# ===============================Settings======================================
#%% Settings
    class Args:
        def __init__(self):
            ...
            self.batch_size = 200 # 20 when 2 gpus, 16 when 4 gpus
            ...
            self.lr = 0.0001
            # number of epochs
            self.num_epochs = 1000 # 30 for 4 gpus
...
#%% Training
    ...
    net = PALACE_v3(smi_encoder, prot_encoder, cross_encoder, decoder,args.feat_space_dim,
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer,'min',patience=2,threshold=1e-6,factor=0.1)
...
if __name__ == '__main__':
    ...
    """
    main(0,world_size,piece,model_id,vocab_dir,loss_log,data_dir,test_dir)
