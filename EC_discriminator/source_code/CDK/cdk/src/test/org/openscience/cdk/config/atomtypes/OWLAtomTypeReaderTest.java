...
public class OWLAtomTypeReaderTest extends CDKTestCase {
    ...
    public void testReadAtomTypes_CDK() {
    	...
    	Assert.assertEquals(0, (int)atomType.getProperty(CDKConstants.PI_BOND_COUNT));
    	Assert.assertEquals(0, (int)atomType.getProperty(CDKConstants.SINGLE_ELECTRON_COUNT));
    }
