...
public class AtomTypeReaderTest extends CDKTestCase {
  ...
  public void testReadAtomTypes_CDK() {
    ...
    public void testReadAtomTypes_FF() {
        ...
        Assert.assertEquals(3, (int)atomType.getProperty(CDKConstants.PART_OF_RING_OF_SIZE));
        Assert.assertEquals(3, (int)atomType.getProperty(CDKConstants.CHEMICAL_GROUP_CONSTANT));
    }
}
