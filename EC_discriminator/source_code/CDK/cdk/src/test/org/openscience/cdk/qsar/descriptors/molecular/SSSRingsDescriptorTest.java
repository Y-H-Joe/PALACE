...
public class SSSRingsDescriptorTest extends MolecularDescriptorTest {
	
	public  SSSRingsDescriptorTest() {}

	@Before
    public void setUp() throws Exception {
		setDescriptor(SSSRingsDescriptor.class);
	}
