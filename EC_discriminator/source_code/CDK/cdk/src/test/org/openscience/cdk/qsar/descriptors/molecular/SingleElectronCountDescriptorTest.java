...
public class SingleElectronCountDescriptorTest extends MolecularDescriptorTest {
	
	public  SingleElectronCountDescriptorTest() {}

	@Before
    public void setUp() throws Exception {
		setDescriptor(TotalNoSingleElectronsDescriptor.class);
	}
