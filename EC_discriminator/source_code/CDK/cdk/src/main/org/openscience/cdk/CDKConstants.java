...
public class CDKConstants {
    ...
    public final static IBond.Order BONDORDER_TRANSITION_SINGLE_NONE = IBond.Order.TRANSITION_SINGLE_NONE;
    public final static IBond.Order BONDORDER_TRANSITION_SINGLE_DOUBLE = IBond.Order.TRANSITION_SINGLE_DOUBLE;
    public final static IBond.Order BONDORDER_TRANSITION_DOUBLE_TRIPLE = IBond.Order.TRANSITION_DOUBLE_TRIPLE;
