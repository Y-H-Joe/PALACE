    ...
    public Object visit(ASTSimpleBond node, Object data) {
        ...
        switch (node.getBondType()) {
            ...
            case SMARTSParserConstants.DN_S_BOND:
                ...
                stereoBonds.add(bond);
                break;
            case SMARTSParserConstants.TS_S_N_BOND:
      			bond = new OrderQueryBond(IBond.Order.TRANSITION_SINGLE_NONE, builder);
      			break;
      		case SMARTSParserConstants.TS_S_D_BOND:
      			bond = new OrderQueryBond(IBond.Order.TRANSITION_SINGLE_DOUBLE, builder);
      			break;
      		case SMARTSParserConstants.TS_D_T_BOND:
      			bond = new OrderQueryBond(IBond.Order.TRANSITION_DOUBLE_TRIPLE, builder);
      			break;                
