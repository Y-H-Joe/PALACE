...
//		mol.addBond(9, 1, IBond.Order.SINGLE); // 11		
    ...
    public static IAtomContainer makePropylRadical()
	{
		IAtomContainer mol = new AtomContainer();
		mol.addAtom(new Atom("C")); // 0
		mol.addAtom(new Atom("C")); // 1
    ...
    public static IAtomContainer makePropane()
   	{
   		IAtomContainer mol = new AtomContainer();
   		mol.addAtom(new Atom("C")); // 0
   		mol.addAtom(new Atom("C")); // 1
    ...
    public static IAtomContainer makePropene()
   	{
   		IAtomContainer mol = new AtomContainer();
   		mol.addAtom(new Atom("C")); // 0
   		mol.addAtom(new Atom("C")); // 1
    ...
    public static IAtomContainer makeAllylRadical()
	{
		IAtomContainer mol = new AtomContainer();
		mol.addAtom(new Atom("C")); // 0
		mol.addAtom(new Atom("C")); // 1
		IAtom carbon = new Atom("C");
		mol.addAtom(carbon); //2
		mol.addElectronContainer(new SingleElectron(carbon)); //2
