...
//                case SINGLE: return "-";
                ...
                case TRANSITION_SINGLE_NONE: return "ç";
                case TRANSITION_SINGLE_DOUBLE: return "@"; 
                case TRANSITION_DOUBLE_TRIPLE: return "&";
                case PARTIAL_SINGLE_DOUBLE: return "à";
                case PARTIAL_DOUBLE_TRIPLE: return "*";
                default: return "";
            }
        } else {
            return "";
    ...
    protected String getVertexSymbol(int vertexIndex) {
    	List<ISingleElectron> selectron = this.molecule.getConnectedSingleElectronsList(this.molecule.getAtom(vertexIndex));
        return this.molecule.getAtom(vertexIndex).getSymbol()+this.molecule.getAtom(vertexIndex).getExactMass()+selectron.size();
    }
    ...
    protected int convertEdgeLabelToColor(String edgeLabel) {
        if (edgeLabel.equals("")) {
            ...
            return 5;
        } else if (edgeLabel.equals("ç")) {
            return 6;
        } else if (edgeLabel.equals("@")) {
            return 7;
        } else if (edgeLabel.equals("&")) {
            return 8;
        } else if (edgeLabel.equals("à")) {
            return 9;
        } else if (edgeLabel.equals("*")) {
            return 10;
        }
