...
public interface IAtomContainer extends IChemObject, IChemObjectListener {
	...
	/** 
	 * Returns the number of stereo centers (both doublebond and tetrahedral)
	 * @return
	 */
	...
	/**
	 *  Returns the total charge on all the atoms in the Container.
	 *  
	 * @return	 The total charge on all the atoms in the Container.
	 */
