...
train_dp = r"data/PALACE_test.nonenzyme.shuf.sample.tsv"
output1_dp = r"PALACE_test.nonenzyme.shuf.sample.primeEC_rxn.tsv"
output2_dp = r"PALACE_test.nonenzyme.shuf.sample.primeEC_fingerprint.tsv"
