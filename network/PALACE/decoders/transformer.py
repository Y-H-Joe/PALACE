...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 15:07:18 2022
...
from PALACE.modules import MultiHeadedAttention, AverageAttention
from PALACE.modules.position_ffn import PositionwiseFeedForward
from PALACE.utils.misc import sequence_mask
...
class TransformerDecoder(DecoderBase):
    ...
    Args:
        ...
        dropout (float): dropout in residual, self-attn(dot) and feed-forward
        attention_dropout (float): dropout in context_attn (and self-attn(avg))
        embeddings (PALACE.modules.Embeddings):
