...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 18:13:57 2022
...
import PALACE
from PALACE.modules.sparse_losses import SparsemaxLoss
from PALACE.modules.sparse_activations import LogSparsemax
from PALACE.utils import make_batch_align_matrix
from PALACE.utils import Statistics
...
def build_loss_compute(model, tgt_field, opt, train=True):
    ...
    if opt.copy_attn:
        criterion = PALACE.modules.copy_generator.CopyGeneratorLoss(
    ...
    if opt.copy_attn:
        compute = PALACE.modules.copy_generator.CopyGeneratorLossCompute(
...
class LossComputeBase(nn.Module):
    ...
    def __call__(self,
        ...
        Returns:
            A tuple with the loss and a :obj:`PALACE.utils.Statistics` instance.
        """
    ...
    def _stats(self, loss, scores, target):
        ...
        Returns:
            :obj:`PALACE.utils.Statistics` : statistics for this batch.
        """
        pred = scores.max(1)[1]
...
class NMTLossCompute(LossComputeBase):
    ...
    def _make_shard_state(self, batch, output, range_, attns=None):
        ...
        if self.lambda_align != 0.0:
            ...
            ref_align =make_batch_align_matrix(
