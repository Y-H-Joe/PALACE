...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 14:47:59 2022
...
class ProteinEncoding(nn.Module):
    """MLP block for learning protein interaction with SMILES
    The first weight Matrix Mp is in shape of 30 * embedding_size, the protein_nn
    output protein feature Matrix is in shape of ProtLen * 30.
    Do matrix multiply to get shape of ProtLen * embedding_size matrix. The Mp 
    should be trained and learn.
    Then do XXXX (evoformer) to convert the ProtLen * embedding_size matrix into
    XXX long vector, passing to encoder.
...
class Embeddings(nn.Module):
    ...
    Args:
        ...
        position_encoding (bool): see :class:`PALACE.modules.PositionalEncoding`
