...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 17 10:15:26 2022
...
import PALACE.decoders.ensemble
import PALACE.translate
from PALACE.translate.beam_search import BeamSearch
from PALACE.translate.greedy_search import GreedySearch
from PALACE.utils.misc import tile, set_random_seed, report_matrix
from PALACE.utils.alignment import extract_alignment, build_align_pharaoh
from PALACE.modules.copy_generator import collapse_copy_scores
...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    if len(opt.models) > 1:
        load_test_model = PALACE.decoders.ensemble.load_test_model
    else:
        load_test_model =onmt.model_builder.load_test_model

    fields, model, model_opt = load_test_model(opt)

    scorer = PALACE.translate.GNMTGlobalScorer.from_opt(opt)
...
class Translator(object):
    ...
    Args:
        model (PALACE.modules.NMTModel): NMT model to use for translation
        fields (dict[str, torchtext.data.Field]): A dict
            mapping each side to its list of name-Field pairs.
        src_reader (PALACE.inputters.DataReaderBase): Source reader.
        tgt_reader (PALACE.inputters.TextDataReader): Target reader.
        gpu (int): GPU device. Set to negative for no GPU.
        n_best (int): How many beams to wait for.
        min_length (int): See
            :class:`PALACE.translate.decode_strategy.DecodeStrategy`.
        max_length (int): See
            :class:`PALACE.translate.decode_strategy.DecodeStrategy`.
        beam_size (int): Number of beams.
        random_sampling_topk (int): See
            :class:`PALACE.translate.greedy_search.GreedySearch`.
        ...
        global_scorer (PALACE.translate.GNMTGlobalScorer): Translation
    ...
    def from_opt(
        ...
        Args:
            model (PALACE.modules.NMTModel): See :func:`__init__()`.
            fields (dict[str, torchtext.data.Field]): See
                :func:`__init__()`.
            opt (argparse.Namespace): Command line options
            model_opt (argparse.Namespace): Command line options saved with
                the model checkpoint.
            global_scorer (PALACE.translate.GNMTGlobalScorer): See
                :func:`__init__()`..
    ...
    def translate(
        ...
        xlation_builder = PALACE.translate.TranslationBuilder(
