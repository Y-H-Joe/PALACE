...
for piece in {1..31}
do
     if test ! -f PALACE_USPTO_STEREO_piece_${piece}_prediction.txt;then
        ~/anaconda3/envs/PALACE/bin/python PALACE_predict_SMILES.py PALACE_models/PALACE_USPTO_STEREO_piece_${piece}.pt data/PALACE_USPTO_STEREO_test.final.tsv vocab/smi_vocab_v2.pkl PALACE_USPTO_STEREO_piece_${piece}_prediction.txt
     fi
done
