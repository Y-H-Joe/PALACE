...
for j in range(4):
    for i in range(32):
        shutil.copy(r'data/PALACE_train.enzyme_and_nonenzyme.shuffle.v40.tsv_{0:04}'.format(i+(j*32)),r'data/PALACE_train.enzyme_and_nonenzyme.shuffle.v40.tsv_{0:04}'.format(i+((j+1)*32)))
