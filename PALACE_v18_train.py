...
from PALACE import (printer,PALACE_v9,logging,save_on_master,train_PALACE,model_diagnose,
                    set_random_seed,load_data,PALACE_Encoder_v2,MaskedSoftmaxCELoss,
                    assign_gpu,init_weights_v2,setup_gpu,PALACE_Decoder_v2,predict_PALACE,
                    test_PALACE)
...
#%% Training
    ...
    decoder = PALACE_Decoder_v2(
        ...
        args.dec_blks, args.dropout, args.prot_blks, args.dec_blks)

    net = PALACE_v9(smi_encoder, prot_encoder,cross_encoder, decoder,args.num_heads,
